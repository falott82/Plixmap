// DOM/image export helpers extracted from EscapeRouteModal.tsx. These are pure
// browser utilities (no component state) used when rasterizing the escape-route
// view to PDF: they inline remote images, rasterize inline SVGs, wait for image
// readiness, and build an off-screen capture node.
