...
const MeetingNotesModal = ({
  ...
  const timelineTaskEvents = useMemo(() => computeTimelineTaskEvents(timelineChain, t, sanitizeManagerActionsForPersist), [sanitizeManagerActionsForPersist, t, timelineChain]);
