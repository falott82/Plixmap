...
import { ChevronLeft, ChevronRight, ChevronsRight, HelpCircle, Image as ImageIcon, Ruler, Search, Trash2, X } from 'lucide-react';
import { toast } from 'sonner';
import { useT } from '../../i18n/useT';
import { getMeetingRoomKioskFallbackLink, useMeetingRoomKioskInfo } from '../meetings/useMeetingRoomKioskInfo';
import { RoomInfoMeasuresModal } from './RoomInfoMeasuresModal';
...
import { COLORS, ColorSwatchPicker } from './RoomModal.helpers';
...
const RoomModal = ({
  ...
  return (
    <>
      ...
      <RoomInfoMeasuresModal {...{ measuresModalOpen, open, setMeasuresModalOpen, shapePreview, measurements, surfaceSqm, setSurfaceSqm, surfaceLocked, t }} />

      <RoomPropertiesModal {...{ propertiesModalOpen, open, setPropertiesModalOpen, name, initialName, kioskLink, kioskRoomId, kioskQrDataUrl, showName, setShowName, logical, setLogical, meetingRoom, setMeetingRoom, meetingProjector, setMeetingProjector, meetingTv, setMeetingTv, meetingVideoConf, setMeetingVideoConf, meetingCoffeeService, setMeetingCoffeeService, meetingWhiteboard, setMeetingWhiteboard, meetingKioskEnabled, setMeetingKioskEnabled, noWindows, setNoWindows, wifiAvailable, setWifiAvailable, fridgeAvailable, setFridgeAvailable, storageRoom, setStorageRoom, bathroom, setBathroom, technicalRoom, setTechnicalRoom, t }} />
