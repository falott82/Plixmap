...
import { CalendarPlus, ClipboardList, Download, History, Info, Languages, Loader2, NotebookText, Plus, Save, Settings2, Share2, SpellCheck, Trash2, Users, X } from 'lucide-react';
