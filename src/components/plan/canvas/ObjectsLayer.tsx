...
import { Arrow, Circle, Group, Image as KonvaImage, Layer, Line, Rect, Text, Transformer, Wedge } from 'react-konva';
import { FloorPlan, MapObject, MapObjectType } from '../../../store/types';
import { TEXT_FONT_OPTIONS, WIFI_RANGE_SCALE_MAX } from '../../../store/data';
