...
import { TEXT_FONT_OPTIONS, WIFI_DEFAULT_STANDARD, WIFI_RANGE_SCALE_MAX } from '../../store/data';
...
import { ObjectWifiSection } from './ObjectWifiSection';
import { ObjectQuoteSection } from './ObjectQuoteSection';
const ObjectModal = ({
  open,
  onClose,
  onSubmit,
            ...
            <div className="flex min-h-full items-center justify-center px-4 py-8">
              ...
              >
                <Dialog.Panel className={`w-full ${isWifi ? 'max-w-4xl' : isSecurityType ? 'max-w-5xl' : 'max-w-md'} modal-panel`}>
                  ...
                  {isWifi ? (
                    <ObjectWifiSection {...{ wifiSource, wifiBrand, wifiModel, wifiModelCode, wifiStandard, wifiBand24, wifiBand5, wifiBand6, wifiCoverageSqm, wifiShowRange, wifiRangeScale, wifiCatalogId, wifiCoverageAreaSqm, wifiCoverageDiameter, wifiCoverageRadius, wifiEffectiveAreaSqm, wifiEffectiveDiameter, wifiEffectiveRadius, wifiFormValid, hasWifiCatalog, readOnly, formatCoverage, setWifiSource, setWifiBrand, setWifiModel, setWifiModelCode, setWifiStandard, setWifiBand24, setWifiBand5, setWifiBand6, setWifiCoverageSqm, setWifiShowRange, setWifiRangeScale, setWifiCatalogId, setWifiCatalogQuery, setWifiCatalogSearchOpen, t }} />
                  ) : null}
                  {canEditLayers ? (
                    <div>
